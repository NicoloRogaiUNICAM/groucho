...
public interface MarkApi {
    ...
    @ApiOperation(value = "Assert that a given state has been observed.", nickname = "markState", notes = "Assert that a given state has been observed. It return TRUE is the state has been maked, FALSE otherwise.", response = Object.class, tags={ "markState", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Object> markState(@ApiParam(value = "The Actual Internal Representation as a String of the Considered State." ,required=true )  @Valid @RequestBody String body
);


    @ApiOperation(value = "Assert that a given state has been observed.", nickname = "markStateLSH", notes = "Assert that a given state has been observed. It return TRUE is the state has been maked, FALSE otherwise. The input parameter is supposed to be a codification in LSH of the actual internal state representation.", response = Object.class, tags={ "markState", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Operation.", response = Object.class),
    ...
    ResponseEntity<Object> markStateLSH(@ApiParam(value = "LSH String of Considered State",required=true) @PathVariable("stateStringLSH") String stateStringLSH
);
